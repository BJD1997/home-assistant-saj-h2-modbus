...
information_sensors_group = SensorGroup(icon="mdi:information-outline")

iso_resistance_sensors_group = SensorGroup(unit_of_measurement="kΩ", icon="mdi:omega")
...
power_sensors = [
    ...
    {
        "name": "CT Grid Power Watt",
        "key": "CT_GridPowerWatt",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "CT PV Power Watt",
        "key": "CT_PVPowerWatt",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "Backup Total Load Power Watt",
        "key": "BackupTotalLoadPowerWatt",
        "icon": "home-lightning-bolt",
        "enable": False,
    },
    {
        "name": "R-Phase Grid Power Watt",
        "key": "RGridPowerWatt",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "S-Phase Grid Power Watt",
        "key": "SGridPowerWatt",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "T-Phase Grid Power Watt",
        "key": "TGridPowerWatt",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "Meter A Real Power 1",
        "key": "Meter_A_PowerW",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "Meter A Real Power 2",
        "key": "Meter_A_PowerW_2",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "Meter A Real Power 3",
        "key": "Meter_A_PowerW_3",
        "icon": "flash",
        "enable": False,
    },
    {
        "name": "CT Grid Power Total",
        "key": "CT_GridPower_total",
        "icon": "transmission-tower",
        "enable": True,
    },
    {
        "name": "R-Phase Inverter Power Watt",
        "key": "RInvPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "S-Phase Inverter Power Watt",
        "key": "SInvPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "T-Phase Inverter Power Watt",
        "key": "TInvPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "R-Phase Off-Grid Power Watt",
        "key": "ROutPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "S-Phase Off-Grid Power Watt",
        "key": "SOutPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "T-Phase Off-Grid Power Watt",
        "key": "TOutPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "R-Phase On-Grid Output Power Watt",
        "key": "ROnGridOutPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "S-Phase On-Grid Output Power Watt",
        "key": "SOnGridOutPowerWatt",
        "icon": "flash",
        "enable": True,
    },
    {
        "name": "T-Phase On-Grid Output Power Watt",
        "key": "TOnGridOutPowerWatt",
        "icon": "flash",
        "enable": True,
    },
]
...
apparent_power_sensors = [
    ...
    {
        "name": "Backup Total Load Power VA",
        "key": "BackupTotalLoadPowerVA",
        "enable": False,
    },
...
voltage_sensors = [
    ...
    {
        "name": "Battery Voltage High Protection",
        "key": "BatProtHigh",
        "icon": "alert",
        "enable": False,
    },
    {
        "name": "Battery Voltage Low Warning",
        "key": "BatProtLow",
        "icon": "alert",
        "enable": False,
    },
    {
        ...
        "key": "Bat_Chargevoltage",
        "icon": "battery-charging",
        "enable": False,
    },
    {
        "name": "Battery Discharge Cut-off Voltage",
        "key": "Bat_DisCutOffVolt",
        "icon": "battery",
        "enable": False,
    },
    {
        "name": "Meter A Voltage 1",
        "key": "Meter_A_Volt1",
        "icon": "sine-wave",
        "enable": False,
    },
    {
        "name": "Meter A Voltage 2",
        "key": "Meter_A_Volt2",
        "icon": "sine-wave",
        "enable": False,
    },
    {
        "name": "Meter A Voltage 3",
        "key": "Meter_A_Volt3",
        "icon": "sine-wave",
        "enable": False,
    },
    ...
    {
        "name": "S-Phase Inverter Voltage",
        "key": "SInvVolt",
        "icon": "sine-wave",
        "enable": True,
    },
    {
        "name": "T-Phase Inverter Voltage",
        "key": "TInvVolt",
        "icon": "sine-wave",
        "enable": True,
    },
    {
        "name": "R-Phase Off-Grid Voltage",
        "key": "ROutVolt",
        "icon": "sine-wave",
        "enable": True,
    },
    {
        "name": "S-Phase Off-Grid Voltage",
        "key": "SOutVolt",
        "icon": "sine-wave",
        "enable": True,
    },
    {
        "name": "T-Phase Off-Grid Voltage",
        "key": "TOutVolt",
        "icon": "sine-wave",
        "enable": True,
    },
    {
        "name": "R-Phase On-Grid Output Voltage",
        "key": "ROnGridOutVolt",
        "icon": "sine-wave",
        "enable": True,
    },
    {
        "name": "S-Phase On-Grid Output Voltage",
        "key": "SOnGridOutVolt",
        "icon": "sine-wave",
        "enable": True,
    },
    {
        "name": "T-Phase On-Grid Output Voltage",
        "key": "TOnGridOutVolt",
        "icon": "sine-wave",
        "enable": True,
    },
...
frequency_sensors = [
    ...
    {
        "name": "S-Phase Inverter Frequency",
        "key": "SInvFreq",
        "icon": "sine-wave",
        "enable": True,
        "suggested_display_precision": 2,
    ...
    {
        "name": "T-Phase Inverter Frequency",
        "key": "TInvFreq",
        "icon": "sine-wave",
        "enable": True,
        "suggested_display_precision": 2,
    ...
    {
        "name": "R-Phase Off-Grid Frequency",
        "key": "ROutFreq",
        "icon": "sine-wave",
        "enable": True,
        "suggested_display_precision": 2,
    ...
    {
        "name": "S-Phase Off-Grid Frequency",
        "key": "SOutFreq",
        "icon": "sine-wave",
        "enable": True,
        "suggested_display_precision": 2,
    ...
    {
        "name": "T-Phase Off-Grid Frequency",
        "key": "TOutFreq",
        "icon": "sine-wave",
        "enable": True,
        "suggested_display_precision": 2,
    ...
    {
        "name": "R-Phase On-Grid Output Frequency",
        "key": "ROnGridOutFreq",
        "icon": "sine-wave",
        "enable": True,
        "suggested_display_precision": 2,
...
current_sensors = [
    ...
    {
        "name": "PV4 Total Current",
        "key": "pv4TotalCurrent",
        "icon": "current-dc",
        "enable": False,
    },
    {
        "name": "R-Phase Grid Current",
        "key": "RGridCurr",
        "icon": "current-dc",
        "enable": False,
    },
    {
        "name": "S-Phase Grid Current",
        "key": "SGridCurr",
        "icon": "current-dc",
        "enable": False,
    },
    ...
    {
        "name": "Meter A Current 1",
        "key": "Meter_A_Curr1",
        "icon": "current-dc",
        "enable": False,
    },
    {
        "name": "Meter A Current 2",
        "key": "Meter_A_Curr2",
        "icon": "current-dc",
        "enable": False,
    },
    {
        "name": "Meter A Current 3",
        "key": "Meter_A_Curr3",
        "icon": "current-dc",
        "enable": False,
    },
    ...
    {
        "name": "S-Phase Inverter Current",
        "key": "SInvCurr",
        "icon": "current-dc",
        "enable": True,
    },
    {
        "name": "T-Phase Inverter Current",
        "key": "TInvCurr",
        "icon": "current-dc",
        "enable": True,
    },
    {
        "name": "R-Phase Off-Grid Current",
        "key": "ROutCurr",
        "icon": "current-dc",
        "enable": True,
    },
    {
        "name": "S-Phase Off-Grid Current",
        "key": "SOutCurr",
        "icon": "current-dc",
        "enable": True,
    },
    {
        "name": "T-Phase Off-Grid Current",
        "key": "TOutCurr",
        "icon": "current-dc",
        "enable": True,
    },
    {
        "name": "R-Phase On-Grid Output Current",
        "key": "ROnGridOutCurr",
        "icon": "current-dc",
        "enable": True,
    },
...
milliampere_sensors = [
    {
        "name": "R-Phase Grid DC Component",
        "key": "RGridDCI",
        "icon": "current-dc",
        "enable": False,
    },
    {
        "name": "S-Phase Grid DC Component",
        "key": "SGridDCI",
        "icon": "current-dc",
        "enable": False,
    },
    {
        "name": "T-Phase Grid DC Component",
        "key": "TGridDCI",
        "icon": "current-dc",
        "enable": False,
    },
    ...
    {
        "name": "R-Phase Off-Grid DVI",
        "key": "ROutDVI",
        "icon": "current-dc",
        "enable": True,
    },
    {
        "name": "S-Phase Off-Grid DVI",
        "key": "SOutDVI",
        "icon": "current-dc",
        "enable": True,
    },
    {
        "name": "T-Phase Off-Grid DVI",
        "key": "TOutDVI",
        "icon": "current-dc",
        "enable": True,
    },
...
battery_sensors = [
    ...
    {"name": "Battery 4 SOH", "key": "Bat4SOH", "icon": "battery", "enable": False},
    {
        ...
        "key": "BatOnGridDisDepth",
        "enable": True,
    },
    {
        "name": "Battery offgrid discharge depth",
        "key": "BatOffGridDisDepth",
        "enable": True,
    },
    ...
    },
    {
        ...
        "key": "BatDischargePower",
        "icon": "battery",
        "enable": True,
    },
    {
        "name": "Grid Charge Power Limit",
        "key": "GridChargePower",
        "icon": "transmission-tower",
        "enable": True,
    },
    {
        "name": "Grid Discharge Power Limit",
        "key": "GridDischargePower",
        "icon": "transmission-tower",
        "enable": True,
    },
]
...
iso_resistance_sensors = [
    ...
    {
        "name": "PV3+ Isolation Resistance",
        "key": "iso3",
        "icon": "omega",
        "enable": False,
    },
    {
        "name": "PV4+ Isolation Resistance",
        "key": "iso4",
        "icon": "omega",
        "enable": False,
    },
...
power_factor_sensors = [
    {
        "name": "R-Phase Grid Power Factor",
        "key": "RGridPowerPF",
        "icon": "power-plug",
        "enable": True,
    },
    {
        "name": "S-Phase Grid Power Factor",
        "key": "SGridPowerPF",
        "icon": "power-plug",
        "enable": True,
    },
    {
        "name": "T-Phase Grid Power Factor",
        "key": "TGridPowerPF",
        "icon": "power-plug",
        "enable": True,
    },
    {
        "name": "Meter A Power Factor 1",
        "key": "Meter_A_PowerFa",
        "icon": "power-plug",
        "enable": False,
    },
    {
        "name": "Meter A Power Factor 2",
        "key": "Meter_A_PowerFa_2",
        "icon": "power-plug",
        "enable": False,
    },
    {
        "name": "Meter A Power Factor 3",
        "key": "Meter_A_PowerFa_3",
        "icon": "power-plug",
        "enable": False,
    },
]
...
information_sensors = [
    ...
    {
        "name": "Charge Time Enable Bitmask",
        "key": "charge_time_enable",
        "icon": "clock-check",
        "enable": True,
    },
    {
        "name": "Discharge Time Enable Bitmask",
...
total_increasing_energy_sensors = [
    ...
    {
        "name": "Battery Pack 1 Discharge",
        "key": "Bat1DischarCap",
        "icon": "battery",
        "enable": True,
    },
    {
        "name": "Battery Pack 2 Discharge",
        "key": "Bat2DischarCap",
        "icon": "battery",
        "enable": False,
    },
    {
        "name": "Battery Pack 3 Discharge",
        "key": "Bat3DischarCap",
        "icon": "battery",
        "enable": False,
    },
    {
        "name": "Battery Pack 4 Discharge",
        "key": "Bat4DischarCap",
        "icon": "battery",
        "enable": False,
    },
    {
        "name": "Total PV Energy 2",
        "key": "total_pv_energy2",
        "enable": False,
        "icon": "solar-power",
    },
    {
        "name": "Total PV Energy 3",
        "key": "total_pv_energy3",
        "enable": False,
        "icon": "solar-power",
    },
]
...
periodic_reset_energy_sensors = [
    ...
    {
        "name": "Today PV Energy 2",
        "key": "today_pv_energy2",
        "reset_period": "daily",
        "enable": False,
        "icon": "solar-power",
    },
    {
        "name": "Month PV Energy 2",
        "key": "month_pv_energy2",
        "reset_period": "monthly",
        "enable": False,
        "icon": "solar-power",
    },
    {
        "name": "Year PV Energy 2",
        "key": "year_pv_energy2",
        "reset_period": "yearly",
        "enable": False,
        "icon": "solar-power",
    ...
    {
        "name": "Today PV Energy 3",
        "key": "today_pv_energy3",
        "reset_period": "daily",
        "enable": False,
        "icon": "solar-power",
    },
    {
        "name": "Month PV Energy 3",
        "key": "month_pv_energy3",
        "reset_period": "monthly",
        "enable": False,
        "icon": "solar-power",
    },
    {
        "name": "Year PV Energy 3",
        "key": "year_pv_energy3",
        "reset_period": "yearly",
        "enable": False,
        "icon": "solar-power",
...
battery_schedule_sensors = [
    ...
    # Second charge slot
    {
        ...
        "key": "charge2_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 2 End Time",
        "key": "charge2_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 2 Day Mask",
        "key": "charge2_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Charge 2 Power Percent",
        "key": "charge2_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    # Third charge slot
    {
        "name": "Charge 3 Start Time",
        "key": "charge3_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 3 End Time",
        "key": "charge3_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 3 Day Mask",
        "key": "charge3_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Charge 3 Power Percent",
        "key": "charge3_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    # Fourth charge slot
    {
        "name": "Charge 4 Start Time",
        "key": "charge4_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 4 End Time",
        "key": "charge4_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 4 Day Mask",
        "key": "charge4_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Charge 4 Power Percent",
        "key": "charge4_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    # Fifth charge slot
    {
        "name": "Charge 5 Start Time",
        "key": "charge5_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 5 End Time",
        "key": "charge5_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 5 Day Mask",
        "key": "charge5_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Charge 5 Power Percent",
        "key": "charge5_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    # Sixth charge slot
    {
        "name": "Charge 6 Start Time",
        "key": "charge6_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 6 End Time",
        "key": "charge6_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 6 Day Mask",
        "key": "charge6_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Charge 6 Power Percent",
        "key": "charge6_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    # Seventh charge slot
    {
        "name": "Charge 7 Start Time",
        "key": "charge7_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 7 End Time",
        "key": "charge7_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Charge 7 Day Mask",
        "key": "charge7_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Charge 7 Power Percent",
        "key": "charge7_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    ...
    # ...existing discharge 2-7 and passive entries with enable: True...
    {
        "name": "Discharge 2 Start Time",
        "key": "discharge2_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 2 End Time",
        "key": "discharge2_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 2 Day Mask",
        "key": "discharge2_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Discharge 2 Power Percent",
        "key": "discharge2_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    {
        "name": "Discharge 3 Start Time",
        "key": "discharge3_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 3 End Time",
        "key": "discharge3_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 3 Day Mask",
        "key": "discharge3_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Discharge 3 Power Percent",
        "key": "discharge3_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    {
        "name": "Discharge 4 Start Time",
        "key": "discharge4_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 4 End Time",
        "key": "discharge4_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 4 Day Mask",
        "key": "discharge4_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Discharge 4 Power Percent",
        "key": "discharge4_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    {
        "name": "Discharge 5 Start Time",
        "key": "discharge5_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 5 End Time",
        "key": "discharge5_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 5 Day Mask",
        "key": "discharge5_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Discharge 5 Power Percent",
        "key": "discharge5_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    {
        "name": "Discharge 6 Start Time",
        "key": "discharge6_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 6 End Time",
        "key": "discharge6_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 6 Day Mask",
        "key": "discharge6_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Discharge 6 Power Percent",
        "key": "discharge6_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
    {
        "name": "Discharge 7 Start Time",
        "key": "discharge7_start_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 7 End Time",
        "key": "discharge7_end_time",
        "icon": "clock-outline",
        "enable": True,
    },
    {
        "name": "Discharge 7 Day Mask",
        "key": "discharge7_day_mask",
        "icon": "calendar",
        "enable": True,
    },
    {
        "name": "Discharge 7 Power Percent",
        "key": "discharge7_power_percent",
        "icon": "flash",
        "unit_of_measurement": "%",
        "enable": True,
    },
...
SENSOR_TYPES = {
    ...
    **create_sensor_descriptions(
        energy_sensors_total_increasing_group, total_increasing_energy_sensors
    ),
    **create_sensor_descriptions(
        energy_sensors_periodic_reset_group, periodic_reset_energy_sensors
    ),
